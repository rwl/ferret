...
void spansBasicTest(Ferret ferret) {
  Directory _dir;
  Searcher _searcher;
  ...
  setUp(() {
    ...
    _searcher = new Searcher.store(ferret, _dir);
  });
  ...
  test('span_term_query', () {
    var tq = new SpanTermQuery(ferret, 'field', "nine");
    check_hits(tq, [7, 23], true);
    tq = new SpanTermQuery(ferret, 'field', "eight");
    check_hits(tq, [6, 7, 8, 22, 23, 24]);
  });

  test('span_multi_term_query', () {
    var tq = new SpanMultiTermQuery(ferret, 'field', ["eight", "nine"]);
    check_hits(tq, [6, 7, 8, 22, 23, 24], true);
    tq = new SpanMultiTermQuery(
        ferret, 'field', ["flip", "flop", "toot", "nine"]);
    check_hits(tq, [2, 7, 12, 17, 23]);
  });

  test('span_prefix_query', () {
    var tq = new SpanPrefixQuery(ferret, 'field', "fl");
    check_hits(tq, [2, 12], true);
  });

  test('span_near_query', () {
    var tq1 = new SpanTermQuery(ferret, 'field', "start");
    var tq2 = new SpanTermQuery(ferret, 'field', "finish");
    var q = new SpanNearQuery(ferret, clauses: [tq1, tq2], in_order: true);
    check_hits(q, [0, 14], true);
    q = new SpanNearQuery(ferret);
    q.add(tq1);
    q.add(tq2);
    check_hits(q, [0, 14, 16, 30], true);
    q = new SpanNearQuery(ferret, clauses: [tq1, tq2], slop: 1, in_order: true);
    check_hits(q, [0, 1, 13, 14]);
    q = new SpanNearQuery(ferret, clauses: [tq1, tq2], slop: 1);
    check_hits(q, [0, 1, 13, 14, 16, 17, 29, 30]);
    q = new SpanNearQuery(ferret, clauses: [tq1, tq2], slop: 4, in_order: true);
    check_hits(q, [0, 1, 2, 3, 4, 10, 11, 12, 13, 14]);
    q = new SpanNearQuery(ferret, clauses: [tq1, tq2], slop: 4);
    check_hits(q, [
      0,
      1,
      2,
    ...
    q = new SpanNearQuery(ferret,
        clauses: [
          new SpanPrefixQuery(ferret, 'field', 'se'),
          new SpanPrefixQuery(ferret, 'field', 'fl')
        ],
        slop: 0);
  ...
  test('span_not_query', () {
    var tq1 = new SpanTermQuery(ferret, 'field', "start");
    var tq2 = new SpanTermQuery(ferret, 'field', "finish");
    var tq3 = new SpanTermQuery(ferret, 'field', "two");
    var tq4 = new SpanTermQuery(ferret, 'field', "five");
    var nearq1 =
        new SpanNearQuery(ferret, clauses: [tq1, tq2], slop: 4, in_order: true);
    var nearq2 =
        new SpanNearQuery(ferret, clauses: [tq3, tq4], slop: 4, in_order: true);
    var q = new SpanNotQuery(ferret, nearq1, nearq2);
    check_hits(q, [0, 1, 13, 14], true);
    nearq1 = new SpanNearQuery(ferret, clauses: [tq1, tq2], slop: 4);
    q = new SpanNotQuery(ferret, nearq1, nearq2);
    check_hits(q, [0, 1, 13, 14, 16, 17, 29, 30]);
    nearq1 =
        new SpanNearQuery(ferret, clauses: [tq1, tq3], slop: 4, in_order: true);
    nearq2 = new SpanNearQuery(ferret, clauses: [tq2, tq4], slop: 8);
    q = new SpanNotQuery(ferret, nearq1, nearq2);
  ...
  test('span_first_query', () {
    ...
    var tq = new SpanTermQuery(ferret, 'field', "finish");
    var q = new SpanFirstQuery(ferret, tq, 1);
    check_hits(q, finish_first, true);
    q = new SpanFirstQuery(ferret, tq, 5);
  ...
  test('span_or_query_query', () {
    var tq1 = new SpanTermQuery(ferret, 'field', "start");
    var tq2 = new SpanTermQuery(ferret, 'field', "finish");
    var tq3 = new SpanTermQuery(ferret, 'field', "five");
    var nearq1 =
        new SpanNearQuery(ferret, clauses: [tq1, tq2], slop: 1, in_order: true);
    var nearq2 = new SpanNearQuery(ferret, clauses: [tq2, tq3], slop: 0);
    var q = new SpanOrQuery(ferret, [nearq1, nearq2]);
    check_hits(q, [0, 1, 4, 5, 9, 10, 13, 14], false);
    nearq1 = new SpanNearQuery(ferret, clauses: [tq1, tq2], slop: 0);
    nearq2 = new SpanNearQuery(ferret, clauses: [tq2, tq3], slop: 1);
    q = new SpanOrQuery(ferret, [nearq1, nearq2]);
  ...
  test('span_prefix_query_max_terms', () {
    _dir = new RAMDirectory(ferret);
    var iw = new IndexWriter(ferret,
        dir: _dir, analyzer: new WhiteSpaceAnalyzer(ferret));
    range(2000)
        .forEach((i) => iw.add_document({'field': "prefix${i} term${i}"}));
    iw.close();
    _searcher = new Searcher.store(ferret, _dir);

    var pq = new SpanPrefixQuery(ferret, 'field', "prefix");
    var tq = new SpanTermQuery(ferret, 'field', "term1500");
    var q = new SpanNearQuery(ferret, clauses: [pq, tq], in_order: true);
    check_hits(q, [], false);
    pq = new SpanPrefixQuery(ferret, 'field', "prefix", max_terms: 2000);
    q = new SpanNearQuery(ferret, clauses: [pq, tq], in_order: true);
